...
class UIManager {
  static elements = {
    ...
    heroPlay: $('#heroPlay'),
    heroMore: $('#heroMore'),
    watchHeroSummary: $('#watchSummary'),
    watchHeroMeta: $('#watchHeroMeta'),
    watchHeroBadges: $('#watchHeroBadges'),
    watchHeroMore: $('#watchHeroMore'),
    watchSynopsis: $('#watchSynopsis'),
    ...
    watchTags: $('#watchTags'),
    watchDetailsMore: $('#watchDetailsMore'),
    ...
    searchFilterLanguages: $('#searchFilterLanguages'),
    searchFilterReset: $('#searchFilterReset'),
    providerExploreSection: $('#providerExploreSection'),
    providerFilterList: $('#providerFilters'),
    providerCarousels: $('#providerCarouselsHome'),
    allFilterSearch: $('#allFilterSearch'),
    allFilterLanguage: $('#allFilterLanguage'),
    allFilterFormat: $('#allFilterFormat'),
    allFilterReset: $('#allFilterReset'),
    profileSwitcher: $('#profileSwitcher'),
    profileSwitchList: $('#profileSwitchList'),
    profileSwitchClose: $('#profileSwitchClose'),
    profileSwitchCancel: $('#profileSwitchCancel'),
    contentDrawer: $('#contentDrawer'),
    contentDrawerClose: $('#contentDrawerClose'),
    contentDrawerBody: $('#contentDrawerBody')
  };
